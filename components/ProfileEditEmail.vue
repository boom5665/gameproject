  ...
  <div class="M-Create-Backgroud Profile Profile-edit-email">
    <div class="navtabs">
      <div class="font-top-myshop">
        ...
        <Nuxt-link class="text-profile" to="/ProfileEditEmail" target="_self">&nbsp; | &nbsp;<span class="font-proL-top">Email</span></Nuxt-link>
      ...
      <div class="form-create">
        <div style="width: 100%">
          <div class="dis-btween">
            <div>
              <div class="but-shop font-top">Email</div>
            </div>
          </div>
          <div>
            <label for="phone">Email <span id="dotstyle">*</span></label>
